...
/**
 * Signals that an account update referenced a role id that resolves to no role. A plain domain
...
public class UnknownRoleException extends RuntimeException {
   ...
   *
   * @param unknownRoleIds the submitted role ids that resolve to no role
   */
